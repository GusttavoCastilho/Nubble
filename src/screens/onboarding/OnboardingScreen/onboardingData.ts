...
type OnboardingPageItemWithoutIndex = Omit<
  OnboardingPageItem,
  'index' | 'total' | 'isLast'
>;

const page1: OnboardingPageItemWithoutIndex = {
  title: [
    {
      text: 'Uma rede social de',
      highlight: false,
    },
    {
      text: ' conexões reais',
...
const page2: OnboardingPageItemWithoutIndex = {
  title: [
    {
      text: 'Compartilhe suas',
      highlight: false,
    },
    {
      text: ' histórias',
...
const page3: OnboardingPageItemWithoutIndex = {
  title: [
    {
      text: 'Interaja',
      highlight: true,
    ...
    {
      text: ' em tempo real com as pessoas',
      highlight: false,
    },
  ],
